                ...
                <div class="result-mai">
                        ...
                        @php
                            ...
                            //  Log::info(print_r($air['outBound'],true)); return;
                                ...
                                $outBound=$air['outBound']->airSegment;
                                 ...
                                 \Illuminate\Support\Facades\Log::info($checkMoreTime);
                    ...
                    <div class="col-12 result-mai-col">
                        ...
                        <div class="card mb-3 border-0">
                            <div class="card-body">
                                <div class="rel-main-img"><img src="images/airimages/3k.gif"  class="air-logo" alt=""> </div>
                                ...
                                <div class="rel-main-info2">
                                    <div class="city-take-col">
                                        <img src="images/airimages/3k.gif" class="cmb-icon">
